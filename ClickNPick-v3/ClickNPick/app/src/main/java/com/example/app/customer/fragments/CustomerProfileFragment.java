...
import com.example.app.customer.CustomerActivity;
...
public class CustomerProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (readArgs()) {
            ...
            final EditText nameField = rootView.findViewById(R.id.nameField);
            ...
            updateBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (name.equals("")) {
                        nameField.setError("Enter shop name!");
                        return;
                    ...
                    updateProfileImpl(name, contactNumber);
                }
            });
    ...
    private void updateProfileImpl(String name, String contactNumber) {
        ...
        task.setToken(AppPreferences.getUserToken(getContext()))
                .execute(Routes.getUpdateCustomerProfileUrl(getContext()));
    }
    ...
    private void uploadImageFinal(String path) {
        ...
        apiTask.setFileToUpload(new File(path))
                .setToken(AppPreferences.getUserToken(getContext()))
